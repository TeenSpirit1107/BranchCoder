...
class ApplyPatchTool(MCPTool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "function": {
                "name": "apply_patch",
                "description": "Apply a unified diff patch to a file. The patch should be in standard unified diff format (starting with --- and +++). This tool can apply patches generated by LLM to modify files.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "patch_content": {
                            "type": "string",
                            "description": "The patch content in unified diff format, or path to a patch file. The patch should start with '---' and '+++' lines indicating the file to patch."
                        },
                        "target_file": {
                            "type": "string",
                            "description": "Optional: Target file path. If not provided, will be extracted from the patch header (--- line). If provided, will override the patch header."
                        },
                        "dry_run": {
                            "type": "boolean",
                            "description": "If true, only validate the patch without applying it (default: false)",
                            "default": False
                        }
                    },
