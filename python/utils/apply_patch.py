#!/usr/bin/env python3
"""
Apply Patch Utility - Apply unified diff patches to files
"""
...
logger = Logger('apply_patch', log_to_file=False)


class ApplyPatch:
    """Utility class for applying unified diff patches to files."""
    
    def __init__(self, workspace_dir: Optional[str] = None):
        """
        Initialize apply patch utility.
        
        Args:
            workspace_dir: Optional workspace directory. Patches will be applied relative to this directory.
        """
        self.workspace_dir: Optional[str] = workspace_dir
        if workspace_dir:
            logger.info(f"Initializing apply patch utility with workspace directory: {workspace_dir}")
    ...
    def set_workspace_dir(self, workspace_dir: str):
        ...
        logger.info(f"Setting workspace directory for apply patch utility: {workspace_dir}")
    ...
    async def apply(self, patch_content: str, target_file: Optional[str] = None, dry_run: bool = False) -> Dict[str, Any]:
        """
