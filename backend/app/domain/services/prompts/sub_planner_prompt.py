SUB_PLANNER_SYSTEM_PROMPT = """You are a professional sub-planner responsible for executing specific tasks assigned by the super planner.
...
SUB_PLANNER_CREATE_PLAN_PROMPT = """
...
SUB_PLANNER_UPDATE_PLAN_PROMPT = """
...
EXAMPLE JSON OUTPUT:
When step 1 is completed and step 2 needs modification:
{{
    "message": "Updated plan after completing step 1, modified step 2 approach",
    "goal": "Search for information about Python web frameworks",
    "title": "Web Framework Research Sub-plan", 
    "steps": [
        {{
            "id": "2",
            "description": "Use search tool to find comprehensive comparison of Django vs Flask vs FastAPI"
        }},
        {{
            "id": "3", 
            "description": "Browse official documentation pages for each framework"
        }},
        {{
            "id": "4",
            "description": "Save research findings to a markdown report file"
        }}
    ]
}}
...
{{
    "execution_plan": "Brief description of your planned approach",
    "steps_executed": [
        {{
            "step": 1,
    ...
    "final_results": "Summary of final execution results",
    "issues_encountered": "Any problems or blockers faced",
...
{{
    ...
    "key_findings_and_results": {{
        "main_achievements": ["list of main achievements"],
        "important_discoveries": ["list of discoveries"],
        "data_collected": ["list of data or information collected"]
    }},
    "tool_usage_summary": {{
    ...
    "issues_and_challenges": {{
        "problems_encountered": ["list of problems"],
        "resolutions_applied": ["how problems were resolved"],
        "unresolved_issues": ["any remaining issues"]
    }},
    "next_steps": {{
        "task_fully_complete": true/false,
        "further_actions_needed": ["list of needed actions"],
...
{{
    "task_completion_status": {{
        ...
        "success_indicators": ["Successfully found framework information", "Created comprehensive report", "All tools worked properly"],
        "completion_percentage": "100%"
    }},
    "key_findings_and_results": {{
        "main_achievements": ["Comprehensive comparison of Django, Flask, and FastAPI", "Identified use cases for each framework", "Created detailed documentation"],
        "important_discoveries": ["FastAPI is best for API development", "Django is ideal for full-stack applications", "Flask offers maximum flexibility"],
        "data_collected": ["Framework features comparison", "Performance benchmarks", "Community support metrics"]
    }},
    "tool_usage_summary": {{
        "tools_used": ["search", "file"],
        "tool_effectiveness": "Excellent - search tool found relevant information quickly, file tool saved reports successfully",
        "tool_issues": []
    }},
    "issues_and_challenges": {{
        "problems_encountered": ["Some documentation sites were slow to load"],
        "resolutions_applied": ["Tried alternative sources", "Used cached versions when available"],
        "unresolved_issues": []
    }},
    "next_steps": {{
        "task_fully_complete": true,
        "further_actions_needed": [],
        "suggestions_for_super_planner": ["Consider creating similar comparisons for other technology stacks", "Report can be used for future framework selection decisions"]
    }}
}}
...
{{
    "executive_summary": {{
        "task_overview": "Brief description of the task",
    ...
    "tool_usage_analysis": {{
        ...
        "tool_purposes": {{"tool_name": "purpose description"}},
        "effectiveness_assessment": "overall tool effectiveness",
        "tool_issues": ["any problems with tools"]
    }},
    "issues_and_resolutions": {{
        "problems_encountered": ["list of issues"],
        "resolution_methods": ["how issues were resolved"],
        "remaining_challenges": ["unresolved issues"]
    }},
    "recommendations": {{
        "improvement_suggestions": ["suggestions for better execution"],
