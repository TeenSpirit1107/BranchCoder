...
FILE_SYSTEM_PROMPT = """You are a professional sub-planner responsible for executing specific tasks assigned by the super planner.
...
FILE_EXECUTE_PROMPT = """Please execute the following task:
...
FILE_SUMMARIZE_PROMPT = """Please summarize the execution of the following task:
...
FILE_REPORT_PROMPT = """Please generate a detailed task execution report:
