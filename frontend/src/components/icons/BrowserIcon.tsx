...
const BrowserIcon: React.FC<BrowserIconProps> = ({ size = 21 }) => {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feBlend mode="normal" in2="effect1_innerShadow_1527_83610" result="effect2_innerShadow_1527_83610"></feBlend>
        </filter>
        <linearGradient 
